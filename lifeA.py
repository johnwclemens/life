...
#        self.addGrid(c=13, r=10) # odd even
    ...
    def addGrid(self, c, r, ww, wh, dbg=1):
        ...
        if dbg: print('addGrid(BGN) c={} r={} ww={} wh={} w={:6.2f} h={:6.2f} x={:6.2f} y={:6.2f} p={} q={}'.format(c, r, ww, wh, w, h, x, y, p, q), file=DBG_FILE)
        for j in range(r):
            tmp1, tmp2 = [], []
            for i in range(c):
                tmp1.append(0)
...
####################################################################################################
    def on_key_press(self, symbol, modifiers):
        ...
        elif symbol == key.E and modifiers == key.MOD_CTRL:  self.erase()
